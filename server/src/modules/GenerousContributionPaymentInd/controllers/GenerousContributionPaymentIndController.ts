// server/src/modules/GenerousContributionPaymentInd/controllers/GenerousContributionPaymentIndController.ts
import { NextFunction, Request, Response } from "express";
import GenerousContributionPaymentIndService from "../services/GenerousContributionPaymentIndService";
import BaseController from "../../base/controllers.ts/BaseController";

export default class GenerousContributionPaymentIndController extends BaseController {
  service = new GenerousContributionPaymentIndService();
  ...
  createPayment = async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (!contributor.name || !contributor.phone) {
        return res.status(400).json({
          success: false,
          error: "Contributor name and phone are required",
        });
      }
