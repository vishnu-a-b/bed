...
router.post("/create-order-hosted", paymentListDoc_1.paymentListDoc, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield controller.createOrderHosted(req, res);
    }
    catch (err) {
        next(err);
    }
