    ...
    createOrderHosted(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const userName = supporter.name || ((_a = supporter.user) === null || _a === void 0 ? void 0 : _a.name);
                const userEmail = (_b = supporter.user) === null || _b === void 0 ? void 0 : _b.email;
                const userPhone = ((_c = supporter.user) === null || _c === void 0 ? void 0 : _c.phoneNumber) || ((_d = supporter.user) === null || _d === void 0 ? void 0 : _d.mobileNo);
                // Create Razorpay order
                const options = {
                    amount: Math.round(Number(supporter.amount) * 100), // Convert to paise
                    currency: ((_e = supporter.bed.country) === null || _e === void 0 ? void 0 : _e.currency) || "INR",
                    receipt: `receipt_${Date.now()}`,
                    notes: {
    ...
    verifyPayment(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!payment) {
                ...
                const allPayments = yield Payment_1.Payment.find({}).select('razorpay_order_id').limit(5);
