...
exports.supporterDetailsDoc = void 0;
const supporterDetailsDoc = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    /*
       #swagger.tags = ['supporter']
       #swagger.responses[200] = {
        description: 'Endpoint to get supporter details',
        schema: {
          success: true,
          data: {
...
exports.supporterDetailsDoc = supporterDetailsDoc;
