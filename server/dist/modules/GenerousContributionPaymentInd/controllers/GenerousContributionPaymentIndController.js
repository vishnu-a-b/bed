...
const GenerousContributionPaymentIndService_1 = __importDefault(require("../services/GenerousContributionPaymentIndService"));
const BaseController_1 = __importDefault(require("../../base/controllers.ts/BaseController"));
class GenerousContributionPaymentIndController extends BaseController_1.default {
    constructor() {
        super(...arguments);
        this.service = new GenerousContributionPaymentIndService_1.default();
...
exports.default = GenerousContributionPaymentIndController;
