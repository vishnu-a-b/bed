...
exports.staffListDoc = void 0;
const staffListDoc = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    /*
       #swagger.tags = ['Staff']
       #swagger.responses[200] = {
        description: 'Endpoint to get Staff list',
        schema: {
          success: true,
          data: {
            total: 1,
...
exports.staffListDoc = staffListDoc;
