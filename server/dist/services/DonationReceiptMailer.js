...
class DonationReceiptMailer {
    ...
    generateReceiptPDF(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const logoPath = path_1.default.join(__dirname, "https://api.donatebed.shanthibhavan.in/logo/logo.png");
            ...
            const tableData = [
                ...
                [
                    "Amount Received",
                    `AUD ${user.amount} (${(0, number_to_words_1.toWords)(user.amount).replace(/\b\w/g, (c) => c.toUpperCase())} Only)`,
                ],
            ...
            doc
                .font("Helvetica")
                .text(" : This is a gift received to support the free treatment of bedridden patients.");
            yPosition += 30;
            addHorizontalLine(yPosition);
            yPosition += 15;
            // Declaration
            ...
            doc
                .font("Helvetica")
                .text(" : This receipt acknowledges that the above amount was donated to Shanthibhavan Palliative International Ltd. No goods or services were received in return for this donation. This donation is tax-deductible under Australian law.", { width: 500 });
            yPosition += 50;
            addHorizontalLine(yPosition);
            yPosition += 15;
            // Registered office
            ...
            doc
                .font("Helvetica")
                .text(" : Shanthibhavan palliative international LTD, Office 3261, Ground Floor, 470 St Kilda Rd, MELBOURNE VIC 3004, Australia", { width: 500 });
            yPosition += 40;
            addHorizontalLine(yPosition);
            yPosition += 15;
            // Contact information
