...
class DonationReceiptMailerIndia {
    ...
    generateReceiptPDF(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const addHorizontalLine = (y, margin = 40) => {
                doc
                    .moveTo(margin, y)
            ...
            const getTextHeight = (text, width, options = {}) => {
                const lines = doc.heightOfString(text, Object.assign({ width }, options));
                return lines;
            };
            let yPosition = 40;
            ...
            yPosition += 20;
            doc.font("Helvetica");
            doc.text(`Thank you for making a contribution of Rs ${user.amount.toLocaleString("en-IN")} on Shanthibhavan. Please keep this written acknowledgement of your payment for your tax records.`, 40, yPosition, { width: 500 });
            yPosition += 35;
            ...
            const amountInWords = (0, number_to_words_1.toWords)(user.amount).replace(/\b\w/g, (c) => c.toUpperCase());
            ...
            // 80G Declaration
            doc.fontSize(10).font("Helvetica");
            doc.text("Payment given to this Trust is eligible for deduction u/s 80G (5) of Income Tax Act 1961 as per Registration no. AAATF4482H/09/16-17/T0072/80G dated 30.09.2016, allotted to the trust by Commissioner of Income Tax (Exemptions), Kochi.", 40, yPosition, { width: 500, align: 'justify' });
            yPosition += 50;
            ...
            doc.text("This is an electronically generated receipt and does not require further validation.", 40, yPosition, { width: 500 });
            yPosition += 25;
            // Registered office
            doc.fontSize(9).font("Helvetica-Bold");
            doc.text("Registered office address: ", 40, yPosition, { continued: true });
            doc.font("Helvetica").text("Shanthibhavan Palliative Hospital, Mountain of Mercy, Pallissery, Arattupuzha P.O, Thrissur - 680562", { width: 500 });
            yPosition += 25;
            // Contact information
            doc.fontSize(9).font("Helvetica-Bold");
            doc.text("Contact: ", 40, yPosition, { continued: true });
            doc.font("Helvetica").text("8921538116, 04876611600 | office@shanthibhavan.in", { width: 500 });
            yPosition += 35;
            // Customer care
            doc.fontSize(9).font("Helvetica-Bold");
            doc.text("Customer Care: ", 40, yPosition, { continued: true });
            doc.font("Helvetica").text("If you have any question regarding this 80G tax deduction certificate, kindly get in touch with our Customer Care team at office@shanthibhavan.in by quoting the Transaction Reference Number", { width: 500 });
            yPosition += 40;
            // Footer
            doc.fontSize(9).font("Helvetica");
            ...
            const pdfBuffer = yield pdfPromise;
            try {
...
exports.default = new DonationReceiptMailerIndia();
