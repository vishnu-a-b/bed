      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white">
            Support Santhibhavan Palliative {isPalliativeInternational?"International":"Hospital"}
          </h2>
        ...
        <div className="text-gray-600 dark:text-gray-300 text-sm md:text-base leading-relaxed space-y-4">
          ...
          <p>
            ...
            our mission by
            <strong> sponsoring a bed at {isPalliativeInternational?"AUD 1200":"Rs. 60,000"}  per month. </strong>{" "}
