    ...
    <div className="flex flex-col space-y-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold text-lg">₹{data.amount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </div>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {data.net_amount && (
                <div>
                  ...
                  <p className="font-medium">₹{data.net_amount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="flex gap-2 pt-4 border-t">
        <Button
          className="text-sm"
          onClick={() => {
            dispatch(setUpdateUrl("generous-payments-ind"));
