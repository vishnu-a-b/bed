...
export async function POST(request: NextRequest) {
  try {
    ...
    // Payment successful, redirect to verify page with query params
    const verifyUrl = new URL('/payment/verify', request.url);
    verifyUrl.searchParams.set('razorpay_payment_id', razorpay_payment_id);
    verifyUrl.searchParams.set('razorpay_order_id', razorpay_order_id);
    verifyUrl.searchParams.set('razorpay_signature', razorpay_signature);
