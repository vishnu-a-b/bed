        ...
        {supporterData?.bedNo != 1000 && (
          ...
          >
            <StatCard
              ...
              value={`${
                supporterData?.currency
              } ${supporterData.totalAmount.toLocaleString()}`}
              ...
              <div className="space-y-2">
                ...
                <DetailRow
                  ...
                  value={
                    supporterData.payments.length > 0
                      ? new Date(
                          supporterData.payments[
                            supporterData.payments.length - 1
                          ].date
                        ).toLocaleDateString()
                      : "N/A"
                  }
                ...
                <DetailRow
                  ...
                  value={
                    supporterData.payments.length > 0
                      ? `${supporterData.currency} ${Math.round(
                          supporterData.totalAmount /
                            supporterData.payments.length
                        ).toLocaleString()}`
                      : "N/A"
                  }
                />
