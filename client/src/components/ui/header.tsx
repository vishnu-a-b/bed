...
export default function Header() {
  ...
  return (
    <header className="w-full shadow-md bg-white dark:bg-gray-900 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        {/* Desktop Info */}
        <div className="hidden md:grid grid-cols-2 gap-x-4 gap-y-1 text-sm text-gray-600 dark:text-gray-300 text-right">
  ...
  <span>📧 office@shanthibhavan.in</span>
      ...
      {/* Mobile Dropdown */}
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 text-sm text-gray-600 dark:text-gray-300 space-y-1">
