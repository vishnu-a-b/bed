...
const variants = {
  base: 'relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[30px] min-w-[40px] border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out',
  image:
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400 text-center   ">drag & drop to upload</div>
                <div className="mt-3">
